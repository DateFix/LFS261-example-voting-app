  ...
  stages {
      ...
      steps {
        ...
        script {
          docker.withRegistry('https://index.docker.io/v1/', 'dockerlogin') {
            def workerImage = docker.build("datefix/worker:v${env.BUILD_ID}", './worker')
            workerImage.push()
    ...
    stage('result-docker-package') {
      ...
      steps {
        ...
        script {
          docker.withRegistry('https://index.docker.io/v1/', 'dockerlogin') {
            def resultImage = docker.build("datefix/result:v${env.BUILD_ID}", './result')
            resultImage.push()
    ...
    stage('vote-docker-package') {
      ...
      steps {
        ...
        script {
          docker.withRegistry('https://index.docker.io/v1/', 'dockerlogin') {
            def voteImage = docker.build("datefix/vote:v${env.BUILD_ID}", './vote')
            voteImage.push()
